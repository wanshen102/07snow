...
<!-- saved from url=(0090)http://cart.jumei.com/i/cart/confirmation/?from=add_to_confirmation_new&rich=1421843164909 -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script charset="utf-8" src="../../../public/js/v.js"></script><script src="../../../public/js/ub.php"></script><script src="../../../public/js/ub(1).php"></script><script type="text/javascript" src="../../../public/js/h.js"></script><script type="text/javascript" async="" src="../../../public/js/dc.js"></script><script src="../../../public/js/saved_resource"></script>
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta property="qc:admins" content="56207406376255516375">
    <title>确认订单 - 聚美优品</title>
        <link rel="stylesheet" href="../../../public/css/jumei.css" type="text/css" media="screen" charset="utf-8">
        <link rel="stylesheet" href="../../../public/css/jumei_cart_new.css" type="text/css" media="screen" charset="utf-8">
        <link rel="stylesheet" href="../../../public/css/jumei_lightbox.css" type="text/css" media="screen" charset="utf-8">
    <script type="text/javascript">
with(window) {
    RM_SITE_MAIN_WEBBASEURL='http://www.jumei.com/';
RM_SITE_MAIN_TOPLEVELDOMAINNAME='jumei.com';
RM_SERVER_TIME=1421843174;
...
.cart_header .order_path_1{
    background: url(http://s0.jmstatic.com/cart/dist/images/v1.3/order_path.jpg) no-repeat;
...
<div style="background: white;">
    ...
    <div class="cart_top">
			  <div class="user_box" id="JS_user_box"><div>欢迎您，<a href="/index.php/home/user/Gr_wddd_qbdd"><?php echo session('user_name') ?></a>&nbsp;<a href="/index.php/home/login/out_login" class="out">[退出]</a><i class="tips">|</i></div></div>
...
<div id="container" style="width: auto;"><link rel="stylesheet" href="./确认订单 - 07Snow_files/jquery-ui-1.8.5.custom.css" type="text/css" media="screen" charset="utf-8">
<script type="text/javascript" charset="utf-8" src="../../../public/js/jquery-ui-1.8.7.custom.min.js"></script>
<style type="text/css">
    ...
    #cboxClose {
        ...
        top: -12px;
        right: -12px;
        background: url(http://p0.jmstatic.com/templates/jumei/images/cart_v2/cart_pop_close.png) no-repeat 0 0 transparent;
        _background:none;
        _filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://p0.jmstatic.com/templates/jumei/images/cart_v2/cart_pop_close.png');
    }
    #cboxClose:hover {
        background: url(http://p0.jmstatic.com/templates/jumei/images/cart_v2/cart_pop_close.png) no-repeat 0 0 transparent;
        _background:none;
...
<div id="cart">
    <div class="countdown_time_wrap">
        <span class="click_icon"></span> <strong>请在 <span class="cart_countdown_time">18分13秒</span> 内提交订单，并在下单后<span>30</span>分钟内完成支付。</strong>
        <a href="javascript:void(0);" class="sp_icon">
            <div class="sp_icon_pos">由于商品库存有限，我们只能暂为您最多保存20分钟，<br>20分钟后购物车将被清空，请尽快结算订单。<div></div></div>
        </a>
    </div>
   <form action="/index.php/home/Indent/indentadd" method="post" id="check_pay_form" onsubmit="return false;" autocomplete="off" style="display:inline-block;">
<div class="cart_left" style="*overflow: hidden">
	<input type="hidden" name="total_price" value="<?php echo $num ?>">
...
<div class="site_edit">
    <div class="clearfix cow_box">
        ...
        <div class="fl clearfix">
            ...
            <div class="fl site_menu_box disabled JS_site_menu_box" style="margin-right:0;display: none;">
                <div>
    ...
    <div class="clearfix cow_box">
        ...
        <div class="fl lab_box"><label>或固定电话：<span class="tips">*</span></label></div>
        ...
        <div class="fl"><input type="text" class="input" placeholder="电话号码" id="JS_phone_number_new" maxlength="8" style="width: 90px;"></div>
        <div class="fl" style="margin: 0 5px;">-</div>
...
<div id="default_address_wrap">
 <?php if(is_array($ress)): foreach($ress as $key=>$vol): ?><div class="content" id="address_wrap">
        <div class="option_box selected" selector="old_address">
        <input type="radio" id="address_ <?php echo ($vol["address_id"]); ?>" value=" <?php echo ($vol["address_id"]); ?>" name="address_id" class="">
        <label for="address_ <?php echo ($vol["address_id"]); ?>" data_address="<?php echo ($vol["address_name"]); ?>" class="address_lbl"><span class="btnEditAddress_new" title="" addressid=" <?php echo ($vol["address_id"]); ?>"></span><span class="btnEditAddress_del" title="" addressid=" <?php echo ($vol["address_id"]); ?>"></span><p>
                <span class="addr_name"> <?php echo ($vol["address_name"]); ?></span>
                <span class="addr_con"> <?php echo ($vol["address_info"]); ?></span>
                <span class="addr_num"> <?php echo ($vo["mobile"]); ?> </span>
            </p>        </label>
        <div class="clear"></div>
...
<div class="address_btns_wrap">
    ...
    <a class="add_address_btn" href="/index.php/home/User/gr_address">使用新地址</a>
...
var modify_count = 0;
var address_count = 4;
var global_authed = false;/*global授权*/
var is_need_id = 0 ? true : false;//是否有海淘商品-(需要验证身份证)
var isSpecialModifyIdCart = is_need_id && modify_count > 9 ? true : false; // 具有特殊权限 如果地址没有身份证 不受10次限制
    ...
    * */
    ...
    var streetselected = function(){
        ...
        $('#JS_address').blur( function () {
            ...
            //!/^[\u4E00-\u9FA5A-Za-z\d\-\s\/\[\]\(\)\#]+$/.test(val) 暂时去掉特殊字符判断
            if (val == '' || val.length < 3 || /^[A-Za-z\d]+$/.test(val)) {
                $this.addClass('error').parent().siblings('.JS_error_box').show();
                return
            } else {
                $this.removeClass('error').parent().siblings('.JS_error_box').hide();
        ...
        */
        ...
        $('.JS_site_menu').unbind().click( function () {
            ...
            $.post('/Confirmation/GetAreaInfos', {
                ...
                for (var i = 0, ii = arrData.length; i < ii; i+=4) {
                    for (var j = 0; j < 4; j++) {
    ...
    var changeCantModifyAddressState = function () {
        if (modify_count < 10) return;
        if (is_need_id) {
            $(".option_box").each(function(key,option_box){
                option_box = $(option_box);
                var editBtn = option_box.find(".btnEditAddress_new");
                if(option_box.find(".id_wrap span").length)else{
                    editBtn.css("right",10);
                }
            });
        } else {
            $(".btnEditAddress_new").remove();
        }
        
        $(".btnEditAddress_del").remove();
    }

    var checkModify10Times = function(){
        if(modify_count>=9){
            if(modify_count==9){
        ...
        wrap.find("#JS_new_address_submit_new").click(function(){
            ...
            if (recipient_name == null || recipient_name == "") {
                ...
                if(!checkName(recipient_name)){
                    ...
                    return false;
                } else if(!china_id_number){
                    alert("请输入您的身份证信息");
                    return false;
                } else if((china_id_number.length!=18 || !isTrueValidateCodeBy18IdCard(china_id_number))){
                    alert('亲，您填写的身份证可能有误，请确保您填写的身份信息正确无误。如您的身份信息在海关系统验证不通过，需要您协助提供相应的身份证复印件给海关，使货物顺利放行。\n姓名：'+recipient_name+'\n身份证号：'+china_id_number);
                    return false;
                }
            } else if (recipient_province == null || recipient_province == "" 
                || recipient_city == null || recipient_city == ""
                || recipient_dist == null || recipient_dist == ""
                || recipient_structuredCode == null || recipient_structuredCode == "") {
                ...
                success:function(data){
                    ...
                    if(data.status == 1){
                        ...
                        var add_html = '<div class="option_box selected" selector="old_address">' +
                            ...
                            '<label for="address_'+ address_id +'" data_address="'+ data.data.address +'" class="address_lbl">' +
    ...
    $('#address_selector .add_address_btn').click(function(){
        ...
        if(checkModify10Times()){return false;}
        $('#address_table').hide();
        $.colorbox({
    ...
    var changeToZeroAddAddress = function(){
        ...
        $('.JS_site_menu_box:not(:first)').addClass('disabled');
            ...
            $.ajax({
                ...
                success:function(data, textStatus, xhr){
                    ...
                    if(status==1){
                        ...
                        confirm_site.city = d.city_code_info;//市
                        confirm_site.county = d.district_code_info;//区
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.status==1){
                        ...
                        if (data.data.id_num) {
                            data_address_obj.find('.id_wrap').html('<span>'+data.data.id_num+'</span>');
                        }
                        $("#cboxClose").click();
...
<div class="cart_left">
    <div class="option" id="prefer_delivery_day">
        ...
        <div class="content">
                ...
                <input id="delivery_day_weekday" name="express" type="radio" value="晚上9点">
                <label for="delivery_day_weekday">晚上9点</label>
                <div class="clear"></div>
            </div>
                        <div class="option_box">
                <input id="delivery_day_weekend" name="express" type="radio" value="下午5点">
                <label for="delivery_day_weekend">下午5点</label>
                <div class="clear"></div>
            </div>
                        <div class="option_box selected">
                <input id="delivery_day_" name="express" type="radio" value="中午12点">
                <label for="delivery_day_">中午12点</label>
                <div class="clear"></div>
            </div>
                        <div class="clb"></div>
        </div>
...
<div class="cart_left relative" style="*z-index: 5;">
    <div class="option cart_products">
        ...
        <div class="cart_products_v2" cart_key="product/804/">
                            <h2><span>此订单将从 <b>聚美优品</b> 发出</span>
 ...
 <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><tr id="1037511_" class="cart_item" deal_hash_id="">
                    <td class="name text_left padd_left"><div style="width:320px;position: relative;line-height: 21px"><a href="http://mall.jumei.com/product_188369.html?_new" target="_blank" class="name_hover"><span class="item_note">  <?php echo ($vo["goods_name"]); ?>  </span></a><div class="pic_hover">
					<?php  $gid.=$vo['id'].","; echo "<input type='hidden' name='goods_id' value='".$gid."'>"; ?>
<img src="" alt="">
</div> </div>
</td><td class="number_box"><?php echo ($vo["goods_num"]); ?></td><td class="price_box">
                        ¥<span id="item-buy-price-1037511_"><?php echo ($vo["goods_price"]); ?></span>
                    </td>
                    <td class="count_price_box bold">
                        ¥<span id="item-buy-total-1037511_"><?php echo ($vo["prices"]); ?></span>
                    </td>
            ...
            应付总额：<span class="total_count">¥<span id="cart_total"><?php echo $num ?></span></span>
        </div>
        <div class="inv_wrap">
                    <input type="checkbox" class="is_need_inv" name="is_need_invoice" value="1"> 索要发票 <span class="inv_quesstion">
                <div>
                1. <strong>发票类型：</strong>聚美目前只支持开具普通发票 <br>
				2. <strong>发票金额：</strong>不包含运费金额以及现金券和红包抵扣的金额；<br>
				3. <strong>发票内容：</strong><br>
				1）订单中聚美优品发货的商品，由聚美开具发票，发票内容根据购买商品所属分类确定。<br>
				2）订单中非聚美优品发货的商品，由商家开具发票，发票内容由商家决定。<br>
    ...
    <div class="adv" style="display:none">
        ...
        <ul class="gateway_ul">
            <!-- <li class="gateway_line ul_on" id="last_choose_mode">
                <input type="radio" name="gateway" id="choose_before" checked="" value="COD">
                <label class="tit" for="choose_before">上次支付方式</label>
                <label class="COD bg" for="choose_before"></label>
                <label class="tit no_cod" style="display: none;"></label>
            </li> -->
            <li class="gateway_line gateway_COD hide" style="display: list-item;">
                <input type="radio" name="gateway" value="货到付款" id="check-cod"><label class="tit" for="check-cod">货到付款</label>
                <label class="tit no_cod" style="display: none;"></label>
                            </li>
         
			<!--
			<li class="gateway_line ul_off gateway_bank">
                <input type="radio" id=""><label class="tit" for="">支付宝/财付通/银联在线/百度钱包</label>
                <label class="tit gateway_desc cup_activity_cod" style="">
                     首次使用百度钱包快捷支付付款，满49立减20元，数量有限，先到先得。 
                                                            &nbsp;&nbsp;
                    <a href="javascript:void(0)">
                        首次用百度钱包支付满49减20
                        <div style="left: -230px;top: -166px;height: auto;width: 600px;">
                            1、2015年01月01日-02月28日，参与活动的用户在PC端下单并支付（单笔订单金额大于49元），且是历史首次使用快捷支付，可享受每笔订单立减20元的优惠。<br>
                            ...
                            5、若使用过程中出现问题，请联系百度钱包：400-8988-855。<br>
                            6、活动过程中如发现违规行为,自动取消其活动资格并追究其法律责任。
                            <span style="top: 152px;"></span>
                        </div>
                    </a>
                                                        </label>
            ...
            <li class="gateway_line ul_off">
                <input type="radio" id=""><label class="tit" for="">网上银行</label><label class="tit gateway_desc" for=""><span>支持地方银行，需开通网银支付功能</span></label>
    ...
    <div class="confirm_pay_box">
        <div class="confirm_pay clearfix">
            ...
            <div class="confirm_right">
                    ...
                    <div class="price_sum">
                        应付总额：<span class="total_count">¥<span id="cart_total2"><?php echo $num ?></span></span>
                    </div>
                </div>
            </div>
        </div>
...
<div id="mobile_confirm" style="display: none;">
    <div class="header">
        <a class="close" href="http://cart.jumei.com/i/cart/confirmation/?from=add_to_confirmation_new&rich=1421843164909#">关闭</a>
        <span class="bold">余额支付安全验证</span>
    </div>
    <div class="step">
        <p id="mobile_step1" style="display: none;"><img src="../../../public/images/cart_step1.jpg" alt=""></p>
        <p id="mobile_step2" style="display: none;"><img src="../../../public/images/cart_step2.jpg" alt=""></p>
    </div>
    <div class="body">
        <p style="margin:5px 0  10px 20px;">为保证您的余额资金安全，请进行手机验证</p>
        <form id="subscribe_form" action="http://cart.jumei.com/i/cart/confirmation/post" class="mobile_subscribe">
            <div class="mobile_form">
                <p style="margin-left: 36px;">
                    <span class="step1 step2 is_bind" style="display: inline;">已绑定</span>手机号：
                    <span class="step1 step2 is_bind bold" style="display: inline;">151****6936</span>
                    
                    <input name="get_confirm_code" id="get_confirm_code" type="button" value="获取校验码" class="get_confirm_code">
                    </p><p class="step1 grey" style="margin: 0px 0px 15px 87px; width: 230px; display: none;">如原手机无法收到短信校验码，请联系聚美客服400-123-8888</p>
                <p></p>

                <p class="step2 not_bind grey" style="margin: 0px 0px 15px 118px; display: none;">请输入正确的11位手机号码</p>
                <p class="is_bind" style="margin:10px 0 15px 87px;">换号了？ <a href="http://cart.jumei.com/i/cart/confirmation/?from=add_to_confirmation_new&rich=1421843164909#" class="bind_new_mobile" id="bind_new_mobile">绑定新手机号</a></p>
                ...
                <p style="margin-left: 36px; display: block;" class="is_bind step1">
                    <span>验证码：</span>
                    <input name="verify_code" id="verify_code" type="text" maxlength="4">
                </p>

                <p style="margin-left: 77px; display: block;" class="is_bind step1">
                    <img id="code" style=" margin-left:10px;" src="../../../public/js/hash_code">
                    <a id="change_code" href="javascript:void(0)">换一张</a>
                </p>

                <p style="margin-left: 87px;">
                    <input type="button" value="确认" class="submit_subscribe is_bind step1" id="rebindcheck" name="rebindcheck" style="display: inline-block;">
                    <input type="button" value="提交手机绑定" class="submit_subscribe not_bind" id="bind" name="bind" style="display: none;">
                    <input type="button" value="绑定手机" class="submit_subscribe step2" id="rebind" name="rebind" style="display: none;">
                </p>

                <p class="bind_tip not_bind grey" style="margin: 0px 0px 15px 15px; display: none;">如原手机无法收到短信验证码，请联系聚美客服400-123-8888</p>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="cart_pop_form">
            <form action="">
                ...
                <p>
                    ...
                    <img id="code" src="../../../public/js/hash_code(1)">
                    <span id="change_code">看不清楚？<b>换一张</b></span>
                </p>
...
<div id="footer_container">
    <div id="footer_textarea">
        <div class="footer_con" id="footer_copyright">
            ...
            <script type="text/javascript" charset="utf-8" src="../../../public/js/Jumei.ClickMap.js"></script>
        </div>
    </div>
</div>        <script type="text/javascript" charset="utf-8" src="../../../public/js/Jumei.Core.js"></script>
        <script type="text/javascript" charset="utf-8" src="../../../public/js/Jumei.Account.js"></script>
        <script type="text/javascript" charset="utf-8" src="../../../public/js/Jumei.OrderNew.js"></script>
        <script type="text/javascript" charset="utf-8" src="../../../public/js/Jumei.OrderConfirmation.js"></script>
        <script type="text/javascript" charset="utf-8" src="../../../public/js/Jumei.MobileBind.js"></script>
        <script type="text/javascript" charset="utf-8" src="../../../public/js/cart_clk_jumei.js"></script>
    <script type="text/javascript">
...
<div style="display:inline;visibility: hidden;"><img height="1" width="1" style="border-style:none;" alt="" src="../../../public/js/saved_resource(1)"></div></body></html>
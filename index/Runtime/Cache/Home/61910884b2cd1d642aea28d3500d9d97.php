...
<!-- saved from url=(0075)http://cart.jumei.com/i/cart/payment_status/?order_id=s11527-14218436440500 -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script charset="utf-8" src="/Public/js/v.js"></script><script src="/Public/js/ub.php"></script><script type="text/javascript" src="/Public/js/h.js"></script><script type="text/javascript" async="" src="/Public/js/dc.js"></script><script src="/Public/js/saved_resource"></script>
    ...
    <script type="text/javascript" async="" src="/Public/css/Jumei.AdStatistics.js"></script><script type="text/javascript">
with(window) {
    RM_SITE_MAIN_WEBBASEURL='http://www.jumei.com/';
RM_SITE_MAIN_TOPLEVELDOMAINNAME='jumei.com';
RM_SERVER_TIME=1421843644;
...
<div style="background: white;">
    ...
    <div class="cart_top">
        <div class="user_box" id="JS_user_box"><div>欢迎您，<a href="/index.php/home/user/Gr_wddd_qbdd"><?php echo session('user_name') ?></a>&nbsp;<a href="/index.php/home/login/out_login" class="out">[退出]</a><i class="tips">|</i><a href="/index.php/home/user/Gr_wddd_qbdd" class="query">订单查询</a></div></div>
    </div>
        ...
        <div class="cart_header clearfix">
            <h1 class="logo_box">
                <a href="/index.php" target="_blank" id="home">
                    <img src="/Public/image/dcf.png" alt="07snow">
                </a>
            </h1>
...
<div id="container" style="width: auto;"><link rel="stylesheet" href="/Public/css/jquery-ui-1.8.5.custom.css" type="text/css" media="screen" charset="utf-8">
    ...
    <div class="cart_left">
        ...
        <!-- COD订单  -->
                ...
                <div class="status_text">
                    ...
                    <h3 style="margin-top:10px;font-weight: 700">感谢您！订单已提交！</h3>
                    <p>
                        应付款<span class="pink">￥<?php echo ($data["total_price"]); ?></span>
                        (共计金额<span class="pink">￥<?php echo ($data["total_price"]); ?></span>）
                    </p>
                </div>
                <div class="clear"></div>
                <!--  -->
            ...
            <div class="order_status order_status_success list_status">
                <h2 class="green" style="color:#333;font-weight: normal;">
                    <span class="pay_icon"></span>
                    以下订单需要货到付款，请在快递上门时支付货款，订单需要客服确认后才能发货，发货前您可以在<a href="http://www.jumei.com/i/order/list">我的订单</a>中取消。
                </h2>
                <table>
                    <colgroup>
                        <col width="250">
                        ...
                        <col width="150">
                            ...
                            <tbody><tr order_id="187184741" is_cod="1">
                                <td>订单号： <span class="pink"><a href="http://www.jumei.com/i/order/detail/?order_id=187184741&from=payment_status"><?php echo ($data["indent_no"]); ?></a></span></td>
                                <td>
                                    
                                    货到付款：￥<?php echo ($data["total_price"]); ?>&nbsp;
                                </td>
                                <td>由 07snow 发货！</td>
                                <td>
                                    <a href="/index.php/home/user/gr_wddd_qbdd" target="_blank">查看详情</a>
                                </td>
                            </tr>
        ...
        <div class="info">
                        <!--
            {if !empty($is_in_sale) && !empty($in_lottery)}
            <p style="font-size: 16px;"><a href="/i/lotterywheel?name=pre0418" target="_blank">您的订单已满199元，恭喜您获得一次抽奖机会，去抽奖</a></p>
            {/if}
            -->
            <p class="btn_container">
                <a class="btn_pink_big" href="/index.php">继续购物</a>
            </p>

                        <div class="app_wrapper">
                <a href="http://www.jumei.com/i/activity/download_app?from=pay_success" target="_blank">
                    <img src="/Public/image/4716_0.jpg" alt="download app">
                </a>
            </div>
            <div class="share_promo">
                <p>复制以下链接给好友注册并购买该商品后，可获20个积分返利！</p>
                <p>
                    <input type="text" value="" id="share-copy-text">
                    <a href="http://cart.jumei.com/i/cart/payment_status/?order_id=s11527-14218436440500#" class="btn_pink_small" id="share-copy-button"><font color='red'>复制</font></a>
                </p>
            </div>
        </div>
        <div class="privilege" style="margin-bottom: 0">
            参加新版购物流程调研问卷，赢百元现金券大奖！<a href="http://www.diaochapai.com/survey759774" target="_blank">立即参加&gt;&gt;</a>
        </div>
        <div class="service" style="margin-top: 0">
            如果您对订单信息或我们的服务有任何疑问，请垂询客服热线 400-123-8888。
        </div>
        </div>
            <style type="text/css">
            .overall{
                ...
                <div class="cart_pop_form">
                    <form action="">
                        ...
                        <p>
                            ...
                            <img id="code" src="/Public/css/hash_code">
...
<!-- Google Code for &#25903;&#20184;&#25104;&#21151; Remarketing List -->
<div style="display:inline;">
    <img height="1" width="1" style="border-style:none;" alt="" src="/Public/image/saved_resource(1)">
</div>
<script>
    var sessionId = 'u52g6a7ndg126ul4sghi6geud6';
    var uid = '11527';
    var time = '1421843644';
    var orderIds = '[187184741]';
    var clientIp = '127.0.0.1';
    window.jumeiSstatistics = window.jumeiSstatistics || [];
    window.jumeiSstatisticsAction = '1';

    jumeiSstatistics.push(['log', 'flow']);
    jumeiSstatistics.push(['lo', '']);
    jumeiSstatistics.push(['sid', sessionId]);
    jumeiSstatistics.push(['cl', 'cart']);
    jumeiSstatistics.push(['mat', '']);
    jumeiSstatistics.push(['bs', '[]']);
    jumeiSstatistics.push(['ps', '[]']);
    jumeiSstatistics.push(['uid', uid]);
    jumeiSstatistics.push(['tm', time]);
    jumeiSstatistics.push(['act', 'order']);
    jumeiSstatistics.push(['aci', orderIds]);
    jumeiSstatistics.push(['ip', clientIp]);
    (function () {
    ...
    <script>
        $(document).ready(function () {
            $(".cross_sale_deal .pic img").lazyload(
                { threshold: 200,
                    effect: "show",
    ...
    <div id="footer_textarea">
        <div class="footer_con" id="footer_copyright">
            <p class="footer_copy_con">
                © 2014 北京八维学院软工07phpD半全体人员 07snow.com 保留一切权利。客服热线：400-123-8888 <br>
...
<div style="display:inline;visibility: hidden;"><img height="1" width="1" style="border-style:none;" alt="" src="/Public/image/saved_resource(2)"></div></body></html>
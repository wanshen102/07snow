		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
				    	<font color='#6600ff'>会员积分列表 </font> <small>Indent  listing</small>
					</h3>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body" >
							...
							<tr >
								...
								<td>
									<?php echo $v['user_id']; ?></a>
								</td>
								<td>
									<?php echo $v['user_name']; ?>
								</td>
								<td>
									 <?php echo $v['in_number']; ?>
								</td>
								<td >
								    <?php echo $v["in_level"]; ?>
							...
							<div>
								<input name="print" type="button" id="btnSubmit1" value="积分已兑换" class="button" disabled="true" onclick="change(1)" />
								 <input name="remove" type="button" id="btnSubmit2" value="积分未兑换" class="button" disabled="true" onclick="change(0)" />
							</div>
						</div>
					</div>

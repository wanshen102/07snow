				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form method="post" action="index.php?r=goods/goodsaddpro" enctype="multipart/form-data" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">商品重量
										<span class="required">
											 *
										</span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" name="goods_weight"/>注：商品重量以g为单位。
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">商品图片
										<span class="required">
											 *
										</span>
										</label>
									...
									<div class="form-group">
										<label class="control-label col-md-3">商品描述
										<span class="required">
											 *
										</span>
										</label>
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<textarea name="goods_desc" rows="" cols="" class="form-control"></textarea>
											</div>

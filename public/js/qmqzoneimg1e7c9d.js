var QMQzoneImg={_mnProjectID:106,_mnPageID:1,_moCaches:{},_moSelParam:null,_moSelCache:{},_mbSupport:true,_moPhotoLogic:null};
...
c._moPhotoLogic.getAlbumList({uin:a.uin,callBack:c._callBackCreater("albums",true,a),errBack:c._callBackCreater("albums",false,a),type:1,refresh:1,"_projectId":c._mnProjectID,"_pageId":c._mnPageID});
});
};
...
c._moPhotoLogic.getNewPhoto({uin:a.uin,callBack:c._callBackCreater("newphoto",true,a),errBack:c._callBackCreater("newphoto",false,a),refresh:1,"_projectId":c._mnProjectID,"_pageId":c._mnPageID});
});
};
...
c._moPhotoLogic.getPhotoList({uin:a.uin||getUin(),id:a.albumId,refresh:1,callBack:c._callBackCreater("photos",true,a),errBack:c._callBackCreater("photos",false,a),"_projectId":this._mnProjectID,"_pageId":this._mnPageID});
});
};
...
var b=this;
b._moSelParam=a;
new QMDialog({sTitle:"QQ\u76F8\u518C",sBodyHtml:QMQzoneImg._TEMPLATE._BODY.replace({images_path:getPath("image"),content:QMQzoneImg._TEMPLATE._MSG.replace({msg:QMQzoneImg._TEMPLATE._LOADING.replace({images_path:getPath("image")})})}),nWidth:500,onload:function(){
var c=this;
...
var e=this,f=QMQzoneImg._TEMPLATE_MENU,c=a.oContainer.ownerDocument,g=c.parentWindow||c.defaultView,d={oTmpl:f,S:function(h){
return S(h,g);
}};
e._moSelParam=a;
a.oContainer.innerHTML=f._BODY.replace({images_path:getPath("image"),content:f._MSG.replace({msg:f._LOADING.replace({images_path:getPath("image")})})});
...
this.getAlbums({onload:function(e,f){
...
new (getTop().QMSelect)({oContainer:l,nWidth:140,sDefaultId:j,oMenu:{nMaxItemView:5,nZIndex:1132,oItems:o},onselect:function(i){
g(i.sId);
}});
g(j);
}
...
this.getPhotos({albumId:b,onload:function(e,f){
...
{
var g=c==l;
j.push(_oTmpl._PHOTO.replace({label:b,value:l,url:f[l].pre,thumbclass:g?"left thumbon pointer attbg bd_upload":"left thumbnone pointer",thumbnone:"left thumbnone pointer",thumbover:"left thumbover pointer settingtable bd",select:g}));
}
k.innerHTML=j.join("");
}
}});
...
createBlankIframe(window,{id:b,defcss:false,className:"",style:"position:absolute;border:none;z-index:99999;right:0;bottom:0;width:1px;height:1px;",header:['<script language="javascript" src="http://qzonestyle.gtimg.cn/ac/qzfl/release/qzfl_for_qzone.js" charset="utf-8"><\/script>','<script language="javascript" src="http://imgcache.qq.com/qzone/client/photo/pages/qzone_v4/script/photo_logic.js" charset="utf-8"><\/script>'].join(""),body:['<body style="padding:0;margin:0;"></body>'],onload:function(){
var c=this;
setTimeout(function(){
...
QMQzoneImg._TEMPLATE._LOADING=T(['<img src="$images_path$ico_loading2104474.gif" align="absmiddle" />','&nbsp;&nbsp;\u76F8\u518C\u6570\u636E\u52A0\u8F7D\u4E2D...']);
...
QMQzoneImg._TEMPLATE_MENU._LOADING=T(['<img src="$images_path$ico_loading2104474.gif" align="absmiddle" />','&nbsp;&nbsp;\u52A0\u8F7D\u4E2D']);
